    ...
    return (
        <Grid>
            ...
            <Grid.Column width={6}>
                    ...
                    { props.editMode && ( <ActivityForm key={props.selectedActivity && props.selectedActivity.id || 0} activity={props.selectedActivity!} setEditMode={props.setEditMode} createActivity={props.createActivity} editActivity={props.editActivity} />)}
            </Grid.Column>
        </Grid>
    )
}
